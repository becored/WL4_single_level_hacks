// @Description Sub_806EC50_WarSidePanel_Attack_21st
// @HookAddress 0x6EC54
...
int Sub_806EC50_WarSidePanel_Attack_21st(unsigned short Ypos,unsigned short Xpos)
{
	unsigned int v2;
	unsigned int v3;
  char v4;
