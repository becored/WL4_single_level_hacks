// @Description CBM_Wario4InitPatch
// @HookAddress 0x5EE0
...
void CBM_Wario4InitPatch() {
    ...
    if (unk_20382E0_SAVE == 0 && unk_20382E1_SAVE == 0 && unk_20382E1_SAVE == 0) {
        unk_20382E0_SAVE = 0x01;
        unk_20382E1_SAVE = 0x00;
